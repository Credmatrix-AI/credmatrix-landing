            ...
            <div>
              <Link href="/" className="inline-block mb-16 md:mb-24">
                <Image
                  ...
                  width={150}
                  height={40}
                  className="h-32 md:h-40 w-auto bg-white rounded-lg p-4"
                />
              </Link>
              <div className="space-y-8 md:space-y-12">
                ...
                <div className="flex items-center gap-8 text-xs sm:text-sm">
                  ...
                  <span>+91-9686866005</span>
                </div>
              </div>
              {/* Social Links */}
              <div className="flex gap-12 md:gap-16 mt-16 md:mt-24">
                {/* linkedin */}
                <a href="https://www.linkedin.com/company/credmatrix-ai" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                ...
                {/* twitter */}
                <a href="https://x.com/credmatrix" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                  <svg className="w-16 h-16 md:w-20 md:h-20" fill="currentColor" viewBox="0 0 24 24">
