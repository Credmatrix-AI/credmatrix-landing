          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-32 md:gap-48">
            ...
            <div>
              ...
              <div className="flex gap-12 md:gap-16 mt-16 md:mt-24">
                {/* linkedin */}
                <a href="https://www.linkedin.com/company/credmatrix-ai" className="hover:text-primary transition-colors">
                ...
                {/* twitter */}
                <a href="https://x.com/credmatrix" className="hover:text-primary transition-colors">
                  <svg className="w-16 h-16 md:w-20 md:h-20" fill="currentColor" viewBox="0 0 24 24">
